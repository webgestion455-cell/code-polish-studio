...
const PDF_DICT: Record<Lang, PdfDict> = {
  fr: {
    ...
    docTitle: "Contrat de prêt — HSBC BANK",
    ...
    lenderSig: "Signature du prêteur", lenderName: "HSBC BANK SAS",
    ...
    footer: "HSBC BANK SAS · contact@lendly.app · MVP de démonstration",
  ...
  en: {
    ...
    docTitle: "Loan agreement — HSBC BANK",
    ...
    lenderSig: "Lender signature", lenderName: "HSBC BANK SAS",
    ...
    footer: "HSBC BANK SAS · contact@lendly.app · Demo MVP",
  ...
  de: {
    ...
    docTitle: "Darlehensvertrag — HSBC BANK",
    ...
    lenderSig: "Unterschrift des Darlehensgebers", lenderName: "HSBC BANK SAS",
  ...
  es: {
    ...
    docTitle: "Contrato de préstamo — HSBC BANK",
    ...
    lenderSig: "Firma del prestamista", lenderName: "HSBC BANK SAS",
    ...
    footer: "HSBC BANK SAS · contact@lendly.app · MVP demo",
  ...
  it: {
    ...
    docTitle: "Contratto di prestito — HSBC BANK",
    ...
    lenderSig: "Firma del prestatore", lenderName: "HSBC BANK SAS",
  ...
  nl: {
    ...
    docTitle: "Leningsovereenkomst — HSBC BANK",
    ...
    lenderSig: "Handtekening kredietverstrekker", lenderName: "HSBC BANK SAS",
  ...
  sl: {
    ...
    docTitle: "Posojilna pogodba — HSBC BANK",
    ...
    lenderSig: "Podpis posojilodajalca", lenderName: "HSBC BANK SAS",
  ...
  bg: {
    ...
    docTitle: "Договор за заем — HSBC BANK",
    ...
    lenderSig: "Подпис на заемодателя", lenderName: "HSBC BANK SAS",
    ...
    footer: "HSBC BANK SAS · contact@lendly.app · Демо MVP",
  ...
  sk: {
    ...
    docTitle: "Zmluva o úvere — HSBC BANK",
    ...
    lenderSig: "Podpis veriteľa", lenderName: "HSBC BANK SAS",
...
export const generateContractPdf = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    y -= 22;
    drawKV(page, helv, helvBold, T.lender, sanitize("HSBC BANK SAS - 12 rue de la Finance, 75002 Paris"), margin, y, ink, muted);
    y -= 16;
