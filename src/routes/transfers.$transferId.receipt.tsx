          ...
          <header className="flex items-start justify-between border-b-2 border-[#db0011] pb-6">
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-semibold tracking-tight text-[#db0011]">HSBC BANK</p>
...
async function buildReceiptPdf(w: Withdrawal) {
  ...
  draw("HSBC BANK", margin + 46, height - 45, 18, bold, red);
  ...
  draw("Document généré par les systèmes sécurisés HSBC BANK.", margin + 16, 166, 9, bold, ink);
