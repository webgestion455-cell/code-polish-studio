    ...
    <div className="mx-auto max-w-3xl px-4 pb-24 pt-6 sm:pb-12 sm:pt-10">
      ...
      <section className="rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <form onSubmit={handleSaveProfile} className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <Input id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} className="mt-1.5" placeholder="+33 6 12 34 56 78" />
          </div>
          <div>
            <Label>Email actuel</Label>
            <Input value={email} disabled className="mt-1.5 bg-muted/40" />
          </div>
          <div className="sm:col-span-2">
      ...
      <section className="mt-6 rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <form onSubmit={handleChangeEmail} className="space-y-4">
          ...
          <Button type="submit" disabled={savingEmail || newEmail === email} variant="secondary">
      ...
      {role === "admin" && (
        <section className="mt-6 rounded-2xl border border-primary/20 bg-primary/5 p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Vous disposez d'un accès administrateur protégé par 2FA. La session admin expire toutes les 8 heures.
          </p>
