...
export const Route = createFileRoute("/legal/aml-kyc")({
  component: AmlPage,
  head: () => ({ meta: [{ title: "AML / KYC Policy — HSBC BANK" }] }),
});

function AmlPage() {
  return (
    <LegalLayout title="Anti-Money Laundering & KYC Policy" updated="2026-06-22">
      <h2>Commitment</h2><p>HSBC BANK applies a zero-tolerance approach to money laundering, terrorism financing and sanctions evasion, in line with EU directives (AMLD5/6), FATF recommendations, and applicable national laws.</p>
