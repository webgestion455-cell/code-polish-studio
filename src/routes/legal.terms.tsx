...
export const Route = createFileRoute("/legal/terms")({
  component: TermsPage,
  head: () => ({ meta: [{ title: "Terms of Service — HSBC BANK" }, { name: "description", content: "The legally binding terms governing your use of HSBC BANK services." }] }),
});

function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" subtitle="By using HSBC BANK you accept the terms below." updated="2026-06-22">
